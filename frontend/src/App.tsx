                ...
                <section id="skills" className="relative z-10 container mx-auto px-6 py-24">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-4 max-w-4xl mx-auto">
                            {[
                                { name: 'Django', svg: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.146 0h3.924v18.166c-2.013.382-3.491.535-5.096.535-4.791 0-7.288-2.166-7.288-6.32 0-4.002 2.65-6.6 6.753-6.6.637 0 1.121.05 1.707.203zm0 9.143a3.894 3.894 0 0 0-1.325-.204c-1.988 0-3.134 1.223-3.134 3.365 0 2.09 1.096 3.236 3.109 3.236.433 0 .79-.025 1.35-.102V9.142zM21.314 6.06v11.098c0 3.872-.28 5.733-1.121 7.336-.79 1.553-1.833 2.54-3.99 3.617l-3.645-1.731c2.158-1.02 3.2-1.928 3.864-3.33.689-1.427.918-3.084.918-7.438V6.061h3.974zM17.339 0h3.975v4.02h-3.975z" /></svg> },
                                ...
                                { name: 'HTML5', svg: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z" /></svg> },
                                ...
                                { name: 'CSS3', svg: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.565-2.438L1.5 0zm17.09 4.413L5.41 4.41l.213 2.622 10.125.002-.255 2.716h-6.64l.24 2.573h6.182l-.366 3.523-2.91.804-2.956-.81-.188-2.11h-2.61l.29 3.855L12 19.288l5.373-1.53L18.59 4.414z" /></svg> },
                                { name: 'SQLite', svg: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M21.678.521c-1.032-.92-2.28-.55-3.513.544L16.911.592c.875-1.078-.882-.801-2.054.562a11.34 11.34 0 0 0-.534.773c-1.745.644-3.75 2.426-5.578 5.048-2.56 3.658-3.95 7.876-3.788 11.03a4.44 4.44 0 0 0 .166 1.068C4.593 20.39 4.03 21.6 4.029 22.566c-.002 1.976 1.376 1.633 2.737-.209.532.213 1.098.264 1.696.146 2.64-.516 5.551-4.089 7.007-8.328.504-1.477.782-2.955.845-4.302l.024-.102c1.063-4.485 2.071-7.077 5.34-9.25zm-9.908 9.59c.135.403-.364 1.098-.504.72C9.93 6.847 6.5 6.94 5.745 9.404c-.105.337-.638.076-.537-.256C6.12 6.336 10.386 6.483 11.77 10.11z" /></svg> },
                                { name: 'MongoDB', svg: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M17.193 9.555c-1.264-5.58-4.252-7.414-4.573-8.115-.28-.394-.53-.954-.735-1.44-.036.495-.055.685-.523 1.184-.723.566-4.438 3.682-4.74 10.02-.282 5.912 4.27 9.435 4.888 9.884l.07.05A73.49 73.49 0 0 1 11.91 24h.481c.114-1.032.284-2.056.51-3.07.417-.296.604-.463.85-.693a11.342 11.342 0 0 0 3.639-8.464c.01-.814-.103-1.662-.197-2.218zm-5.336 8.195s0-8.291.275-8.29c.213 0 .49 10.695.49 10.695-.381-.045-.765-1.76-.765-2.405z" /></svg> },
                                ...
                                { name: 'Git', svg: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M23.546 10.93L13.067.452c-.604-.603-1.582-.603-2.188 0L8.708 2.627l2.76 2.76c.645-.215 1.379-.07 1.889.441.516.515.658 1.258.438 1.9l2.658 2.66c.645-.223 1.387-.078 1.9.435.721.72.721 1.884 0 2.604-.719.719-1.881.719-2.6 0-.539-.541-.674-1.337-.404-1.996L12.86 8.955v6.525c.176.086.342.203.488.348.713.721.713 1.883 0 2.6-.719.721-1.889.721-2.609 0-.719-.719-.719-1.879 0-2.598.182-.18.387-.316.605-.406V8.835c-.217-.091-.424-.222-.608-.406-.547-.547-.676-1.366-.396-2.028L7.608 3.642l-7.146 7.15c-.604.603-.604 1.58 0 2.187l10.48 10.48c.604.604 1.582.604 2.186 0l10.418-10.42c.604-.603.604-1.579 0-2.186z" /></svg> },
                            ].map((skill, i) => (
                                <motion.div
                                    key={i}
                                    initial={{ opacity: 0, y: 20 }}
